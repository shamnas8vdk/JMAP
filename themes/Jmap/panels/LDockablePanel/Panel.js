...
define(['dojo/_base/declare',
  ...
  function(
    ...
    _TemplatedMixin, template, BaseWidgetPanel, LoadingIndicator, utils,WidgetManager,query
  ) {
    //jshint unused:false
    /****
    ...
    return declare([BaseWidgetPanel, _TemplatedMixin], {
      ...
      startup: function(){
        ...
        if(Array.isArray(this.config.widgets)){
          ...
          this.position.right = 0 - this.position.width;
      ...
      setPosition: function(position){
        this.inherited(arguments);
        //topic.publish('changeMapPosition', {right: this.position.right + this.position.width});
      },
      ...
      _onBarClick: function() {
        if (this.windowState === 'maximized') {
          this.panelManager.minimizePanel(this);
          //topic.publish('changeMapPosition', {right: 0});
        } else {
          this.panelManager.maximizePanel(this);
        }
      }
