    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        setTimeout(function(){
          ...
          helpLink[0].href = 'http://gis.calhouncounty.org/WAB/V2.7/widgets/Identify/help/identify_Help.htm';
      ...
      getConfig: function() {
        ...
        this.config.infoautoclosemilliseconds = parseInt(this.autoClose.get('value'), 10) * 1000;
