...
define([
  ...
  domClass, domStyle, NlsStrings, WidgetManager) {
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    AnchorBarController: WidgetManager.getInstance().getWidgetById('themes_Jmap_widgets_AnchorBarController_Widget_21'),
    ...
    _onCkSelectNodeClick: function(layerInfo, ckSelect, evt) {
      ...
      evt.stopPropagation();
      this.AnchorBarController._hideShowIconItem(this.layerListWidget.mapTo, layerInfo.title, ckSelect.checked);
    },
